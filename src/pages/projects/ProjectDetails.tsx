    ...
    <>
      <div className="space-y-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white dark:focus:ring-slate-600 dark:focus:ring-offset-slate-950"
        >
            ...
            <>
              <div className="relative">
                ...
                {tasksFetching && !tasksLoading && (
                  <div
                    className="pointer-events-none absolute inset-x-0 top-0 h-0.5 overflow-hidden rounded-t-xl bg-slate-200 dark:bg-slate-800"
                    aria-hidden="true"
                  >
                    <div className="h-full w-1/3 animate-pulse bg-slate-500 dark:bg-slate-400" />
                  </div>
                )}
              </div>
