...
const TaskTable = ({ tasks, onTaskClick, onEditTask }: TaskTableProps) => {
  return (
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <div className="min-w-0">
                      <p
                        title={task.title}
                        className="max-w-[280px] truncate text-sm font-medium text-slate-900 dark:text-slate-100"
                      >
                        {task.title}
                      </p>
                      ...
                      {task.description && (
                        <p
                          ...
                          className="mt-1 max-w-[280px] truncate text-xs text-slate-500 dark:text-slate-400"
                        >
                          {task.description}
                        </p>
                      )}
